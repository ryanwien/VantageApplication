...
export default {
  ...
  "These check off as you use the app.": "Sie haken sich ab, während du die App nutzt.",
  "Claim {n} hours of Pro Desk": "{n} Stunden Pro Desk einlösen",
  "Live data, AI answers, video and streaming. Starts when you claim it, not now.": "Live-Daten, KI-Antworten, Video und Streaming. Startet beim Einlösen, nicht jetzt.",
  "Pro Desk pass active · {t} left": "Pro-Desk-Pass aktiv · noch {t}",
  "Your Pro Desk pass has run out.": "Dein Pro-Desk-Pass ist abgelaufen.",
  "See plans": "Tarife ansehen",
  "OPEN": "OFFEN", "CLOSED": "GESCHLOSSEN",
  "standing by": "bereit",
  "Voice & anchor settings": "Stimme & Moderator-Einstellungen", "SET": "KULISSE", "free": "kostenlos",
  "ASK ALL": "ALLE FRAGEN",
 "Summarize {sym} today": "Fasse {sym} heute zusammen", "What's moving today?": "Was bewegt sich heute?", "What's on Netflix?": "Was läuft auf Netflix?", "Write a report → PPT": "Bericht schreiben → PPT",
 ...
 "ENVIRONMENT": "UMGEBUNG",
  ...
  "No login needed — turn on ♪ and the player docks bottom-right. (Spotify's embed plays 30-second previews without an account; full tracks play automatically if you're already signed in to Spotify in this browser.)": "Keine Anmeldung nötig — schalte ♪ ein und der Player dockt unten rechts an. (Spotifys Embed spielt 30-Sekunden-Vorschauen ohne Konto; vollständige Titel laufen automatisch, wenn du in diesem Browser bereits bei Spotify angemeldet bist.)", "● connected — full tracks enabled": "● verbunden — vollständige Titel aktiviert", "connecting…": "verbinde…",
 ...
 "Upgrade": "Upgrade", "Switch": "Wechseln",
  ...
  "piece": "Figur",
  // --- settings: the plain-language sidebar ---
  "{sym} session, down {pct}%": "{sym}-Sitzung, minus {pct} %",
  "{sym} session, up {pct}%": "{sym}-Sitzung, plus {pct} %",
  ...
  "Down {pct}% on light volume. Support held at {level}.": "Minus {pct} % bei dünnem Volumen. Die Unterstützung hielt bei {level}.",
  "Up {pct}% on steady volume. Resistance gave way at {level}.": "Plus {pct} % bei stetigem Volumen. Der Widerstand fiel bei {level}.",
