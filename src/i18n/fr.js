...
export default {
 ...
 "Summarize {sym} today": "Résumez {sym} aujourd'hui", "What's moving today?": "Qu'est-ce qui bouge aujourd'hui ?", "What's on Netflix?": "Qu'y a-t-il sur Netflix ?", "Write a report → PPT": "Rédiger un rapport → PPT",
 ...
 "Upgrade": "Passer à supérieur", "Switch": "Changer",
  ...
  "piece": "pièce",
  // --- settings: the plain-language sidebar ---
  "{sym} session, down {pct}%": "Séance {sym}, en baisse de {pct} %",
  "{sym} session, up {pct}%": "Séance {sym}, en hausse de {pct} %",
  ...
  "Down {pct}% on light volume. Support held at {level}.": "En baisse de {pct} % sur de faibles volumes. Le support a tenu à {level}.",
  "Up {pct}% on steady volume. Resistance gave way at {level}.": "En hausse de {pct} % sur des volumes réguliers. La résistance a cédé à {level}.",
