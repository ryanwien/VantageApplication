...
export default {
 ...
 "Summarize {sym} today": "Resume {sym} hoy", "What's moving today?": "¿Qué se mueve hoy?", "What's on Netflix?": "¿Qué hay en Netflix?", "Write a report → PPT": "Escribe un informe → PPT",
 ...
 "Upgrade": "Mejorar", "Switch": "Cambiar",
  ...
  "piece": "pieza",
  // --- settings: the plain-language sidebar ---
  "{sym} session, down {pct}%": "Sesión de {sym}, baja un {pct} %",
  "{sym} session, up {pct}%": "Sesión de {sym}, sube un {pct} %",
  ...
  "Down {pct}% on light volume. Support held at {level}.": "Baja un {pct} % con poco volumen. El soporte aguantó en {level}.",
  "Up {pct}% on steady volume. Resistance gave way at {level}.": "Sube un {pct} % con volumen constante. La resistencia cedió en {level}.",
