...
export default {
 ...
 "Summarize {sym} today": "Resumir {sym} hoje", "What's moving today?": "O que está a mover-se hoje?", "What's on Netflix?": "O que há na Netflix?", "Write a report → PPT": "Escrever um relatório → PPT",
 ...
 "Upgrade": "Melhorar", "Switch": "Mudar",
  ...
  "piece": "peça",
  // --- settings: the plain-language sidebar ---
  "{sym} session, down {pct}%": "Sessão da {sym}, a descer {pct} %",
  "{sym} session, up {pct}%": "Sessão da {sym}, a subir {pct} %",
  ...
  "Down {pct}% on light volume. Support held at {level}.": "A descer {pct} % com pouco volume. O suporte aguentou nos {level}.",
  "Up {pct}% on steady volume. Resistance gave way at {level}.": "A subir {pct} % com volume constante. A resistência cedeu nos {level}.",
