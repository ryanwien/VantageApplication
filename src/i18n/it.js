...
export default {
  ...
  "These check off as you use the app.": "Si spuntano da sole mentre usi l'app.",
  "Claim {n} hours of Pro Desk": "Riscatta {n} ore di Pro Desk",
  "Live data, AI answers, video and streaming. Starts when you claim it, not now.": "Dati live, risposte IA, video e streaming. Parte quando lo riscatti, non ora.",
  "Pro Desk pass active · {t} left": "Pass Pro Desk attivo · {t} rimasti",
  "Your Pro Desk pass has run out.": "Il tuo pass Pro Desk è scaduto.",
 ...
 "Summarize {sym} today": "Riassumi {sym} oggi", "What's moving today?": "Cosa si muove oggi?", "What's on Netflix?": "Cosa c'è su Netflix?", "Write a report → PPT": "Scrivi un report → PPT",
 ...
 "ENVIRONMENT": "AMBIENTE",
  ...
  "No login needed — turn on ♪ and the player docks bottom-right. (Spotify's embed plays 30-second previews without an account; full tracks play automatically if you're already signed in to Spotify in this browser.)": "Nessun accesso necessario — attiva ♪ e il player si ancora in basso a destra. (L'embed di Spotify riproduce anteprime di 30 secondi senza account; i brani completi partono automaticamente se hai già effettuato l'accesso a Spotify in questo browser.)", "● connected — full tracks enabled": "● collegato — brani completi attivati", "connecting…": "connessione…",
 ...
 "Upgrade": "Passa a superiore", "Switch": "Cambia",
  ...
  "piece": "pezzo",
  // --- settings: the plain-language sidebar ---
  "{sym} session, down {pct}%": "Seduta di {sym}, in calo dello {pct}%",
  "{sym} session, up {pct}%": "Seduta di {sym}, in rialzo dello {pct}%",
  ...
  "Down {pct}% on light volume. Support held at {level}.": "In calo dello {pct}% con volumi sottili. Il supporto ha tenuto a {level}.",
  "Up {pct}% on steady volume. Resistance gave way at {level}.": "In rialzo dello {pct}% con volumi costanti. La resistenza ha ceduto a {level}.",
